...
public class QpaperController {
    ...
    private static final String UPLOAD_DIR = "uploads/qpaper/";
    ...
    public ResponseEntity<List<StudyResourceResponse>> getStudyResources(
        ...
        if (searchTerm == null || searchTerm.trim().isEmpty()) {
            resources = studyResourceRepository.findQpapersByBasicFilters(
                    semester, department, regulation, subjectName);
        } else {
            try {
                resources = studyResourceRepository.searchQpapers(
    ...
    public ResponseEntity<StudyResourceResponse> uploadStudyResource(
        ...
        try {
            ...
            studyResource.setFilePath("/uploads/qpaper/" + fileName);
